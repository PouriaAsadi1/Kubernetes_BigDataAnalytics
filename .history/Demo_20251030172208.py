...
def main() -> Optional[int]:
    ...
    input_path = "/Users/pouriaasadi/taxi-data-sorted-small.csv"  # e.g. local:///opt/spark/data/taxi-data-sorted-small.csv
    output_path = "/Users/pouriaasadi/Kubernetes_BigDataAnalytics/"  # e.g. s3a://my-bucket/taxi-output
    display_rows = 10
